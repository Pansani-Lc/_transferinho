...
SECRET_KEY = 'django-insecure-$!p-mo5*c*)n3)7+b-0x9(&tjdoo4=d5-+euj#&bl^(c)tps)%'
...
# Tupla que informa que direciona os arquivos estaticos para dentro da pasta base_static.
STATICFILES_DIRS = (
